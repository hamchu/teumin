...
public class RecruitMainController extends Client {
    ...
    @FXML
    void showRegisterView(MouseEvent event) throws Exception {
        Stage stage = (Stage) recruit_list.getScene().getWindow();
        stage.close();

        stage.setScene(new Scene(loadFxml("admin/recruitManagement/RegisterRecruitView.fxml")));
        stage.show();
    }
